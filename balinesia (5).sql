...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2018 at 10:32 AM
...
INSERT INTO `event` (`event_id`, `evkat_id`, `user_id`, `event_nama`, `des_event`, `price_ev`, `slot_member`, `ev_place`, `ev_date`) VALUES
(1, 1, 0, 'Perkawinan silang', 'Pernikahan merupakan hal yang wajar dan wajib ya ', 200000, 200, 'disini ', '2018-05-18'),
(2, 2, 0, 'Metatah', 'haha ', 300000, 300, 'haha ', '2018-05-11'),
(3, 1, 0, 'Nganten', 'Nganten wajib ', 8000000, 10, 'disini ', '2018-05-24'),
(4, 2, 0, 'Menikah', 'Disini rumah kami tempat padi terhampar samudranya kaya raya tanah kami subur tuan ', 2000000, 20, 'Dimana ', '2018-05-22'),
(5, 1, 0, 'ini', 'disana ', 20000, 20, 'disana ', '2018-05-11'),
(7, 2, 1, 'Mepandes masal', 'Susunan acara terlampir ', 200000, 200, 'Yadnya ', '2018-05-16'),
(8, 1, 1, 'Menikah', 'Disini hahaha ', 20000, 20000, 'Disini ', '2018-05-17'),
(9, 1, 1, 'Menikah', 'Disnanaa ', 20000, 20, 'disini ', '2018-05-17'),
(10, 1, 1, 'aa', 'aaaa', 20000, 200, 'da', '2018-05-10'),
(11, 1, 1, 'aa', 'aaaa', 20000, 200, 'da', '2018-05-10'),
(12, 2, 1, 'a', 'aaa', 2, 2, 'da', '2018-05-03'),
(13, 2, 1, 'a', 'aaa', 2, 2, 'da', '2018-05-03'),
(15, 1, 1, 'a', 'aaa', 200000, 200, 'daaaaaaa', '2018-05-17'),
(16, 2, 1, 'Mepandes', 'mepandes', 100000, 100, 'gianyar', '2018-05-02');
...
--
-- Dumping data for table `fot_event`
--

INSERT INTO `fot_event` (`foto_id`, `event_id`, `url_event`) VALUES
(1, 15, 'uploadupacara/230520181137321 - Copy.jpg'),
(2, 15, 'uploadupacara/230520181137321.jpg'),
(3, 15, 'uploadupacara/230520181137322 - Copy.jpg'),
(4, 15, 'uploadupacara/230520181137322.jpg'),
(5, 16, 'uploadupacara/24052018063635112095.jpg');
...
--
-- Dumping data for table `fot_sar`
--

INSERT INTO `fot_sar` (`fotsar_id`, `sarana_id`, `url_sarana`) VALUES
(1, 3, 'uploadbanten/230520181151231 - Copy.jpg'),
(2, 3, 'uploadbanten/230520181151231.jpg'),
(3, 3, 'uploadbanten/230520181151232 - Copy.jpg'),
(4, 3, 'uploadbanten/230520181151242.jpg'),
(5, 3, 'uploadbanten/230520181152181 - Copy.jpg'),
(6, 3, 'uploadbanten/230520181152191.jpg'),
(7, 3, 'uploadbanten/230520181152192 - Copy.jpg'),
(8, 3, 'uploadbanten/230520181152192.jpg'),
(9, 3, 'uploadbanten/230520181153581 - Copy.jpg'),
(10, 3, 'uploadbanten/230520181153581.jpg'),
(11, 3, 'uploadbanten/230520181153582 - Copy.jpg'),
(12, 3, 'uploadbanten/230520181153582.jpg');
...
INSERT INTO `sarana` (`sarana_id`, `sarkat_id`, `user_id`, `sar_nama`, `des_sar`, `dibuat`, `stock_sar`, `sar_price`, `pilihan`) VALUES
(2, 1, 1, 'banten ', 'wawawaa ', 'Jalan Tukad Yeh Jinah No.5, Samplangan, Gianyar ', 200, 200, 'Ready'),
(3, 1, 1, 'aaa', 'aaaaa', 'Jalan Tukad Yeh Jinah No.5, Samplangan, Gianyar ', 2000, 200, 'Ready'),
(4, 1, 1, 'aaa', 'aaaaa', 'Jalan Tukad Yeh Jinah No.5, Samplangan, Gianyar ', 2000, 200, 'Ready'),
(5, 1, 1, 'aaa', 'aaaaa', 'Jalan Tukad Yeh Jinah No.5, Samplangan, Gianyar ', 2000, 200, 'Ready');
...
--
-- Dumping data for table `sar_kategori`
--

INSERT INTO `sar_kategori` (`sarkat_id`, `sarkat_nama`) VALUES
(1, 'Nista'),
(2, 'Madya');
...
(1, 'I Dewa Gede Budiastawa', 'budiastawa44', 'Jalan Tukad Yeh Jinah No.5, Samplangan, Gianyar ', 13300, 1104, 1221, 'uploaduser/240520181700491.jpg', 'budiastawa44@gmail.com', 'informatika', 'informatika', '2018-04-24', '089635922035', 'Male'),
(2, 'Ida Bagus Andika Putra', 'gusdikaputra', 'Jalan Tukad Yeh Jinah ', 13300, 1104, 1221, 'uploaduser/14052018182603bag1.jpg', 'gusdika11@yahoo.com', 'informatika', 'informatika', '2018-04-24', '089635922035', 'Male'),
(3, 'I Dewa Gede Budiastawa', 'admin44', 'Jalan Tukad Yeh Jinah No.5, Samplangan, Gianyar ', 13300, 1104, 1221, 'uploaduser/17052018173926Budiastawa.png', 'budiastawa44@gmail.com', 'admin1234', 'admin1234', '2018-04-24', '089635922035', 'Male');
...
--
ALTER TABLE `event`
  MODIFY `event_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `fot_event`
  MODIFY `foto_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `fot_sar`
--
ALTER TABLE `fot_sar`
  MODIFY `fotsar_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `sarana`
  MODIFY `sarana_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
