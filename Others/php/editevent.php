...
<body>
    <div id="wrapper">
        <div id="header">
                ...
                <div id="login">
                    <a href="../html/index.html" id="tomreg">Home</a>
                </div>
        </div>
        <div id="body">
            <div id="isi">
                <h1 style="text-align: center; color: #487eb0;">Tambah Event</h1>
                <form method="POST" action="updateevent.php">
                    ...
                    <div class="form-group">
                        <textarea type="text" id="desvent" class="form-control" name="desvent" value="<?php echo $row['des_event'];?>" required autocomplete="off"></textarea>
                    </div>
                    <div class="form-group">
